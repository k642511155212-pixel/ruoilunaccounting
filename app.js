(() => {
  ...
  function renderDashboard(){
    ...
    main.innerHTML=`<div class="page">
      <div class="hero-strip dashboard-hero"><div class="hero-copy"><span class="hero-kicker">UPDATED CLASS WORKBOOK · YELLOW / BLACK EDITION</span><h1>Study. Work it out. Check the structure.</h1><p>Expanded theory, interactive explained questions, Vietnamese key terms, a complete 15-chapter ebook exercise library, uploaded source packs, and Accounting Lab worksheets for teacher and textbook exercises.</p><div class="hero-actions"><a class="btn primary" href="#lab">Open Accounting Lab</a><a class="btn hero-light" href="#practice">Start Practice</a><a class="btn hero-ghost" href="#learn/ch1">Course Map</a></div></div><img src="${window.AM_VISUALS.hero}" alt="Yellow and black accounting ledger illustration" class="dashboard-hero-art"></div>
